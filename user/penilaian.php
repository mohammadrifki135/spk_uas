...
if (isset($_POST['simpan'])) {
    ...
    $query = $conn->query("SELECT * FROM penilaian WHERE alternative='$alternative'");
    ...
    if ($query->num_rows > 0 ) {
        ...
        $query = $conn->query("INSERT INTO penilaian(alternative,akreditasi,fasilitas,magister,ukm,biaya) VALUES ('$alternative','$akreditasi','$fasilitas','$magister','$ukm','$biaya')");
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					<header class="page-header">
							...
							<header class="panel-heading">
								...
								<div class="panel-body">
										...
										<form class="form-group" method="POST">
											...
											<div class="col-md-6">
											<select name="alternative" id="alternative" class="form-control col-lg-8">
                                    			<?php
                        ...
                        <section class="panel">
							<header class="panel-heading">
						        <h2 class="panel-title">Data Penilaian</h2>
							</header>
                                <div class="panel-body">
