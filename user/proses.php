					...
					<header class="page-header">
						...
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Metode Penentu Keputusan Referensi</h2>
							</header>
							<div class="panel-body">
								<p>Multi Attribute Utility Theory (MAUT) merupakan suatu metode perbandingan kuantitatif yang biasanya mengkombinasikan pengukuran atas biaya resiko dan keuntungan yang berbeda. Setiap kriteria yang ada memiliki beberapa alternatif yang mampu memberikan solusi [6]. Untuk mencari alternatif yang mendekati dengan keinginan user maka untuk mengidentifikasikannya dilakukan perkalian terhadap skala prioritas yang sudah ditentukan. Sehingga hasil yang terbaik dan paling mendekati dari alternatif alternatif tersebut yang akan diambil sebagai solusi [7]</p>
								<caption> <i>Fuad El Khair, Sarjon Defit, Yuhandri Yunus, Universitas Putra Indonesia YPTK Padang</i> </caption>
							</div>
						</section>
