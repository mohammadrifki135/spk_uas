...
if (isset($_POST['simpan'])) {
    ...
    $query = $conn->query("INSERT INTO alternative(nama_kampus,alamat) VALUES ('$nama_kampus','$alamat')");
					...
					<header class="page-header">
                        ...
                        <section class="panel">
							<header class="panel-heading">
						        <h2 class="panel-title">ALTERNATIVE</h2>
							</header>
									...
									<form action="" method="POST">
										<div class="form-group row">
											<label class="col-sm-2 col-form-label">Nama Kampus</label>
												<div class="col-sm-6">
													<input type="text" class="form-control" name="nama_kampus" placeholder="nama_kampus" required>
												</div>
										</div>
										<div class="form-group row">
                        ...
                        <section class="panel">
							<header class="panel-heading">
						        <h2 class="panel-title">Data Alternative</h2>
							</header>
                                <div class="panel-body">
